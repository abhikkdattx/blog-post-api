...
import com.theabhikdatta.blog.rest.api.payload.ErrorDetail;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // blogApi custom exception handler
    ...
    public ResponseEntity<ErrorDetail> handleBlogApiException(Exception ex,
                                                              WebRequest request){
        ErrorDetail errorDetail = new ErrorDetail(
                new Date(),
                ex.getMessage(),
